...
class Fruit_Vegetable:
    def __init__(self):
        pygame.init()
        self.screen = pygame.display.set_mode((800, 600))
        pygame.display.set_caption("Hangman - Fruit_Vegetable")
        self.clock = pygame.time.Clock()

        self.categories = ["Fruit_Vegetable"]
        self.word = random.choice(categories["Fruit_Vegetable"]).upper()  # Získá náhodné slovo ze seznamu pro kategorii "Fruit_Vegetable"
      ...
      # Seznam s názvy souborů obrázků hangmana
        self.hangman_images = ["hangman_0.png", "hangman_1.png", "hangman_2.png", "hangman_3.png", "hangman_4.png", "hangman_5.png",
                               "hangman_6.png"]
    ...
    def draw(self):
        ...
        background_image = pygame.image.load(os.path.join(image_folder, "fruits_vegetables.png"))
        ...
        # Vykreslení hádaných písmen ve třetí čtvrtině horní části obrazovky barevně
    ...
    def win_screen(self): # to same jako nahoře ale pří výhře
        script_dir = os.path.dirname(__file__)
        image_folder = os.path.join(script_dir,"pictures")
                        ...
                        if 600 <= x <= 630:  # klikání na první sloupec abecedy
                            ...
                            if clicked_letter not in self.guessed_letters:
                                ...
                                if clicked_letter not in self.word:
                                    ...
                                    self.current_hangman_index += 1  # Zvýšení indexu obrázku hangmana - další pngd
                                    if self.lives == 0:
    ...
    def reset_game(self):
        self.word = random.choice(categories["Fruit_Vegetable"]).upper()
