...
class Animals:
    def __init__(self):
        ...
        pygame.display.set_caption("Hangman - Animals")
        self.clock = pygame.time.Clock()

        self.categories = ["Animals"]
        self.word = random.choice(categories["Animals"]).upper()  # Získá náhodné slovo ze seznamu pro kategorii "Animals"
      ...
      # Seznam s názvy souborů obrázků hangmana
        self.hangman_images = ["hangman_0.png", "hangman_1.png", "hangman_2.png", "hangman_3.png", "hangman_4.png", "hangman_5.png", "hangman_6.png"]
    ...
    def draw(self):
        ...
        background_image = pygame.image.load(os.path.join(image_folder, "animals.png"))
